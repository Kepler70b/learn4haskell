...
-}
mid :: Int -> Int-> Int ->Int
mid x y z= min (max x y ) (max (min x y) z)
--LOL i tried this same problem like 3 times and saw i forgot to reload the file :facapalm:--
{- |
=⚔️= Task 8
...
-}
sumLast2 :: Int->Int
sumLast2 n =  lastn n + lastn( div n 10)
    where
      lastn:: Int-> Int
      lastn n= mod n 10
